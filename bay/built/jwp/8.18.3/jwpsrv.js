!function() {
    ...
    function Re(e, a, t) {
        ...
        e.playlistItemData.mediaId = he(u),
        ...
        e.playlistItemData.duration = b(e),
        e.meta.lastEvent = a,
        e.meta.lastBucket = t,
        ...
        a = a,
        t = t,
        -1 === Be.indexOf(a) && (e.meta.eventPreAbandonment = f(a, t))
    }
    var Me = {
        prs: function(e) {
    ...
    Xe.vs = function(e) {
        ...
        return function(e, a, t, n) {
            ...
            return Te(e.getContainer(), "jw-flag-audio-player") ? 6 : (e = 0 | n.width,
            n = 0 | n.height,
    ...
    function la(t, e, a, n) {
        ...
        n = S({}, da, n = 3 < arguments.length && void 0 !== n ? n : {});
        Re(t, e, a);
        e = f(e, a),
        a = pe.events[e];
    ...
    function ca(e) {
        ...
        e.bidders.forEach(function(e) {
            ...
            N.forEach(function(e) {
                var a;
                "result" === e ? n.result = x[t[e]] : S(n, void 0 !== t[e] ? ((a = {})[e] = t[e],
                a) : void 0),
    ...
    var va = {
        ...
        adTime: function(e, a) {
            ...
            n = ma(i = d, o = n),
            o = r.ads.pingLimiters.visibleEvent.canSendPing(ce) || r.ads.pingLimiters.visibleEvent.canSendPing(le),
            ...
            l.visibleEvent.canSendPing(ce) && d.totalVisibleSeconds >= Math.floor(t.duration / 2) && (la(e, ce, "clienta"),
            l.visibleEvent.setPingSent(ce)),
            l.visibleEvent.canSendPing(le) && 2 <= d.maxConsecutiveVisibleSeconds && (la(e, le, "clienta"),
            l.visibleEvent.setPingSent(le)),
    ...
    function ya(n) {
        ...
        e.on("adClick adRequest adMeta adImpression adComplete adSkipped adError adTime adBidRequest adBidResponse adStarted adLoaded adViewableImpression adBreakEnd", function(e) {
            ...
            n.ads.adPlaybackTracking = S({}, B)),
            t = e,
            -1 === L.indexOf(t.type) && ua(n, e),
            e.type in va ? va[e.type](n, e) : -1 === V.indexOf(e.type) && la(n, M[e.type], "clienta")
        })
    }
    function ba(a) {
        function e() {
    ...
    function Da(e) {
        ...
        wa(t) && (clearTimeout(t.seekDebounceTimeout),
        a = la(e, "vs", "jwplayer6", {
            delaySend: !0
        }),
    ...
    function Ea(d, l) {
        return function(e) {
            ...
            l === Sa && ((a = e.segment) && (r.segmentReceived = !0,
            ...
            r.currentPosition = o),
            l === Ta && (E(d, U),
            "flash_adaptive" === v(i) ? !d.meta.playbackSent && r.segmentReceived && (d.meta.playbackSent = !0,
            r.segmentReceived = !1,
            Pa(d)) : d.meta.playbackSent || (d.meta.playbackSent = !0,
            Pa(d)))
        }
    }
    function Ca(e) {
    ...
    function Oa(c) {
        ...
        .bind(null, c), a = function(e, a) {
            ...
            t && t === he(a.item) && (e.playerData.lastErrorCode[W] = a.code,
            la(e, "paf", "error"))
        }
        .bind(null, c);
        ...
        u.on("idle", Ga.bind(null, c)),
        u.on("ready", function(e) {
            c.playlistItemData.ready = S({}, e),
            c.playerData.viewable = u.getViewable(),
            c.playerData.muted = u.getMute(),
            c.playerData.volume = u.getVolume();
            try {
        ...
        u.on("playlistItem", function(e) {
            ...
            t && (a.mediaId = he(t),
            Se(c, t)),
            a.ready && (c.meta.playbackTracking.posterVideoThumbnail = we(e.item),
            t = c,
            e = a.ready,
        ...
        u.on("time", function(e) {
            ...
            if (n)
                if (c.meta.seekTracking.dragStartTime)
                    ...
                    l);
                    if (Aa(c, t.playedSecondsTotal, l, 10),
                    Aa(c, t.playedSecondsTotal, l, 30),
                    Aa(c, t.playedSecondsTotal, l, 60),
                    t.playedSecondsTotal = t.playedSecondsTotal + l,
                    !0 === t.sendSetTimeEvents && (xa(c, n, 3),
                    xa(c, n, 10),
                    xa(c, n, 30)),
                    r <= 0 || r === 1 / 0)
        ...
        u.on("seek", function(e) {
            c.meta.playbackTracking.previousTime = m(u),
        ...
        u.on("visualQuality", function(e) {
            ...
            a = t,
            e = !1,
            y.width === a.width && y.height === a.height || (e = !0),
            y = a,
            e && -1 === r.indexOf(t.reason) && la(c, "vqc")
        }),
        u.on(i.join(" "), function() {
            c.ads.adBreakTracking && (c.ads.adBreakTracking.shouldTrack = !0)
        }),
        u.on("error", Ba.bind(null, c, se)),
        u.on("setupError", Ba.bind(null, c, ue)),
        ...
        u.on("captionsChanged", function(e) {
            0 !== e.track && 0 === c.playerData.captionsIndex && la(c, ee),
        ...
        Ga(c),
        e = _,
        (a = c).meta.previousBufferTimes[e] = Ke(a)
    }
    function Na(e, a) {
        e.related.feedId = ve(a),
        e.related.feedInstanceId = ye(a),
        e.related.feedType = ke(a, "kind"),
        ...
        e.related.pinSetId = be(a.target),
        e.related.advanceTarget = he(a.target),
    ...
    function _a(t) {
        t.external.playerAPI.on("ready", function() {
            ...
            !(e = (a = t).external.playerAPI).getPlugin || (e = e.getPlugin("sharing")) && e.on("click", function(e) {
                a.sharing.shareMethod = Qa[e.method] || Qa.custom,
                la(a, K)
            })
        })
    }
    function za(e) {
        var a;
        a = e,
        "function" == typeof navigator.sendBeacon && ba(a),
        Oa(e),
        ya(e),
        Ua(e),
        _a(e)
    ...
    function rt(e, a, t) {
        ...
        return {
            ...
            v.autostart in D && (e.autostartConfig = D[v.autostart]),
