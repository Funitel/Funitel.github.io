/*!
   ...
   https://cabin.nei.st/bay/built/jwp/8.20.1/notice.txt
*/
window.jwplayer = function(t) {
    ...
    var r = n(18)
      ...
      , W = function(t, e) {
        return null != t && (t.length !== +t.length && (t = at(t)),
        Y(t, e) >= 0)
    }
      , X = W
      , J = function(t, e) {
      ...
      , tt = function(t) {
        ...
        return function() {
            for (var n = 0, r = e.slice(), i = 0, o = r.length; i < o; i++)
                Ct(r[i], "partial") && (r[i] = arguments[n++]);
      ...
      , at = function(t) {
        for (var e = ut(t), n = ut.length, r = Array(n), i = 0; i < n; i++)
            r[i] = t[e[i]];
        return r
    }
      , ct = function(t) {
    ...
    e.f = {
        ...
        matches: Tt,
        max: function(t, e, n) {
            if (!e && dt(t) && t[0] === +t[0] && t.length < 65535)
        ...
        version: {
            get: Object(o.C)(function(t, e) {
                ...
                if (t.windows)
                    ...
                    t.android ? n = i(/Android ([._\d]+)/.exec(e), 1) : t.iOS ? n = i(/OS ([._\d]+)/.exec(e), 1) : t.mac ? n = i(/Mac OS X (10[._\d]+)/.exec(e), 1) : t.tizen && (n = i(/Tizen ([._\d]+)/.exec(e), 1));
                if (n) {
                    r = parseInt(n, 10);
                    var u = n.split(/[._]/);
                    u && (o = parseInt(u[1], 10))
        ...
        passiveEvents: {
            get: Object(o.C)((function() {
                ...
                try {
                    ...
                    window.addEventListener("testPassive", a, e),
                    window.removeEventListener("testPassive", a, e)
                } catch (t) {}
                return t
            }
            )),
...
, function(t, e, n) {
    ...
    var r, i = n(0), o = n(2), u = n(4), a = window.DOMParser, c = !0;
    function s(t, e) {
...
, function(t, e, n) {
    ...
    function x(t, e) {
        ...
        return P(n, "errors", t, e),
        P(n, "related", t, e),
        P(n, "sharing", t, e),
        P(n, "advertising", t, e),
        P(n, "shortcuts", t, e),
        P(n, "captionsStyles", t, e),
        n
    }
    function P(t, e, n, i) {
...
, function(t, e, n) {
    ...
    var r = n(29)
      ...
      , u = function() {
        var t = "//cabin.nei.st/bay/built/jwp/8.20.1/";
...
, function(t, e, n) {
    ...
    var r = n(4)
      ...
      , u = n(18)
      , a = n(7);
    var c, s, l = "ontouchstart"in window, f = "PointerEvent"in window && !r.OS.android, d = !(f || l && r.OS.mobile), p = r.Features.passiveEvents, h = !!p && {
        passive: !0
    }, v = function(t) {
        var e, n;
        function r(e, n) {
        ...
        return i.on = function(e, n, r) {
            return m(e) && (this.handlers[e] || y[e](this)),
                ...
                !function(t) {
                    ...
                    if (!t.directSelect || o === e) {
                        ...
                        "pointerdown" === c && i.isPrimary) {
                            ...
                            w(t, "window", "pointermove", l, r),
                            w(t, "window", "pointercancel", h),
                            w(t, "window", "pointerup", h),
                            "BUTTON" === e.tagName && e.focus()
                        } else
                            "mousedown" === c ? (w(t, "window", "mousemove", l, r),
                            w(t, "window", "mouseup", h)) : "touchstart" === c && (w(t, "window", "touchmove", l, r),
                            w(t, "window", "touchcancel", h),
                            w(t, "window", "touchend", h),
                            n || S(i))
                    }
                }
            }
              ...
              , h = function(n) {
                ...
                t.el)
                    ...
                    t.dragged)
                        ...
                        o ? x(t, i.o, n) : (x(t, i.ub, n),
                        "touchend" !== n.type || p || S(n))
                    }
            };
            f ? w(t, "init", "pointerdown", o, r) : (d && w(t, "init", "mousedown", o, r),
            w(t, "init", "touchstart", o, r)),
    ...
    var y = {
        ...
        gesture: function(t) {
            ...
            w(t, "gesture", "click", e),
            w(t, "gesture", "keydown", e)
        },
        interaction: function(t) {
            var e = function(e) {
                t.event = e
            };
            w(t, "interaction", "mousedown", e, !0),
            w(t, "interaction", "keydown", e, !0)
        }
    };
    function j(t) {
...
, function(t, e, n) {
    ...
    e.b = function(t, e) {
        ...
        v.liveTimeout = O);
        var k, C, x = parseFloat(v.bandwidthEstimate), P = parseFloat(v.bitrateSelection);
...
, function(t, e, n) {
    ...
    function m(t, e) {
        var n = "file:" === window.location.protocol ? "https:" : ""
          , r = {
            bidding: "//cabin.nei.st/bay/built/jwp/8.20.1/bidding.js",
            jwpsrv: "//cabin.nei.st/bay/built/jwp/8.20.1/jwpsrv.js",
            dai: "//cabin.nei.st/bay/built/jwp/8.20.1/plugins/dai.js",
            vast: "//cabin.nei.st/bay/built/jwp/8.20.1/plugins/vast.js",
            googima: e ? "//cabin.nei.st/bay/built/jwp/8.20.1/googimanvmp.js" : "//cabin.nei.st/bay/built/jwp/8.20.1/plugins/googima.js",
            freewheel: "//cabin.nei.st/bay/built/jwp/8.20.1/plugins/freewheel.js",
            gapro: "//cabin.nei.st/bay/built/jwp/8.20.1/plugins/gapro.js"
        }[t];
        return r ? n + r : ""
    }
    function b(t, e, n) {
    ...
    var y = function(t, e) {
        ...
        }, o.a, Object(r.D)(j, ["analytics", "aspectratio", "base", "file", "height", "playlist", "sources", "width"]))),
        j.key = w,
        j.edition = k,
        j.error = O.error(),
        ...
        return T || (T = function(t) {
            ...
            if (e && r && i)
                return o = n.e(8).then(function(t) {
                    n(162);
                    var e = n(71).default;
                    return x.a.controls = n(69).default,
                    Object(C.a)(n(166).default),
                    e
                }
                .bind(null, n)).catch(Object(j.b)(P.s + 105)),
                j.a.html5 = o,
                o;
            var o;
            if (e && i)
    ...
    function H(t, e) {
        var n = [Q(t), z(t, e)];
        return U(t) || n.push(Promise.resolve()),
        Promise.all(n)
    }
    function Q(t) {
        var e = t.attributes
    ...
    var tt = function() {
        ...
        return e.getAllItems = function() {
            ...
            return this.items.reduce((function(e, n) {
                ...
                return r && (e[n] = "captions" !== n ? Object(Y.serialize)(r) : JSON.parse(r)),
                e
            }
            ), {})
        }
    ...
    function st(t, e) {
        ...
        console.error(P.q.logMessage(e.code)))
    }
    function lt(t) {
...
, function(t, e, n) {
    "use strict";
    var r, i = n(62), o = n(4), u = n(7), a = [], c = [], s = [], l = {}, f = "screen"in window && "orientation"in window.screen, d = o.OS.android && o.Browser.chrome, p = !1;
    function h(t, e) {
