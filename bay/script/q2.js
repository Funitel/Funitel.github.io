...
var ScrollOut = function() {
    ...
    function m() {}
    return function(L) {
        var i, P, _, H, o = (L = L || {}).onChange || m, l = L.onHidden || m, c = L.onShown || m, s = L.onScroll || m, f = L.cssProps ? (i = L.cssProps) : m, e = L.scrollingElement, A = e ? v(e)[0] : window, W = e ? v(e)[0] : document.documentElement, x = !1, O = {}, y = []
...
!function(e, t) {
    ...
    var p = function(n) {
        var e, p, x, o, i, h, f, g, w, u, l, C, T, a, E, v, s, c, y, A = "sizzle" + 1 * new Date, d = n.document, N = 0, r = 0, m = ue(), b = ue(), S = ue(), k = ue(), D = function(e, t) {
            return e === t && (l = !0),
            0
        }, L = {}.hasOwnProperty, t = [], j = t.pop, q = t.push, O = t.push, P = t.slice, H = function(e, t) {}, I = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", M = "\\[" + R + "*(" + B + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + B + "))|)" + R + "*\\]", W = ":(" + B + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", F = new RegExp(R + "+","g"), $ = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), z = new RegExp("^" + R + "*," + R + "*"), _ = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), U = new RegExp(R + "|>"), V = new RegExp(W), X = new RegExp("^" + B + "$"), Q = {
            ID: new RegExp("^#(" + B + ")"),
            CLASS: new RegExp("^\\.(" + B + ")"),
            TAG: new RegExp("^(" + B + "|[*])"),
            ATTR: new RegExp("^" + M),
        ...
        ce(function(e) {}) || fe("type|href|height|width", function(e, t, n) {}),
        p.attributes && ce(function(e) {}) || fe("value", function(e, t, n) {}),
        ce(function(e) {}) || fe(I, function(e, t, n) {}),
        se
    }(g);
    E.find = p,
    E.expr = p.selectors,
    ...
    var $e = ["Webkit", "Moz", "ms"]
      ...
      , _e = {};
    var Ve, Xe, Qe = /^(none|table(?!-c[ea]).+)/, Ye = /^--/, Ge = {}, Ke = {};
    E.extend({
        cssHooks: {},
        cssNumber: {},
        cssProps: {},
...
, function(t, e, n) {
    function o(t) {
        var e, n = t.store, o = t.eventId, i = t.eventTarget, u = t.eventStateKey, a = t.actionListId, c = t.groupIndex, f = void 0 === c ? 0 : c, l = t.immediate, E = t.verbose, d = n.getState(), _ = d.ixData, I = d.ixSession, v = _.events[o] || {}, p = v.mediaQueries, T = void 0 === p ? _.mediaQueryKeys : p, S = (0,
        s.default)(_, "actionLists.".concat(a), {}), A = S.actionItemGroups, R = S.useFirstGroupAsInitialState;
        if (!A || !A.length)
            return !1;
        f >= A.length && (0,
    ...
    e.startEngine = function(t) {
        var e, n = t.store, o = t.rawData, r = t.allowEvents, i = t.testManual, u = n.getState().ixSession;
        o && n.dispatch((0,
        A.rawDataImported)(o)),
        ...
        -1 === (e = document.documentElement).className.indexOf(D) && (e.className += " ".concat(D)),
...
, function(t, e, n) {
    ...
    var r, i, u, a = n(1), c = a(n(42)), f = a(n(31)), s = n(1);
    Object.defineProperty(e, "__esModule", {
        value: !0
    }),
    ...
    e.getAffectedElements = function(t) {
        ...
        var C, L, m, D = (0,
        d.default)(n, "action.config.affectedElements", {})[O || A] || {}, h = Boolean(D.id || D.selector), M = n && c(o(n.target));
        ...
        return null == L || null == m ? [] : v.IS_BROWSER_ENV && i ? f(m).filter((function(t) {}
        )) : C === F ? f(L, m) : C === x ? s(f(L)).filter(E(m)) : C === X ? l(f(L)).filter(E(m)) : f(m)
    }
    ,
...
, function(t, e, n) {
    ...
    t.exports = function(t, e, n) {
        ...
        var l, E, d, _, I, v, p = 0, T = !1, O = !1, S = !0;
        if ("function" != typeof t)
            throw new TypeError("Expected a function");
        return e = i(e) || 0,
        o(n) && (T = !!n.leading,
...
, function(t, e, n) {
    var o, r = n(1), i = r(n(31)), u = r(n(42)), a = n(1);
    Object.defineProperty(e, "__esModule", {
        value: !0
    }),
    e.default = void 0;
    var c, f, s, l = a(n(30)), E = a(n(362)), d = a(n(50)), _ = a(n(381)), I = n(6), v = n(145), p = (n(87),
    n(29)), T = I.EventTypeConsts, O = T.MOUSE_CLICK, S = T.MOUSE_SECOND_CLICK, A = T.MOUSE_DOWN, y = T.MOUSE_UP, R = T.MOUSE_OVER, g = T.MOUSE_OUT, N = T.DROPDOWN_CLOSE, C = T.DROPDOWN_OPEN, L = T.SLIDER_ACTIVE, m = T.SLIDER_INACTIVE, D = T.TAB_ACTIVE, h = T.TAB_INACTIVE, M = T.NAVBAR_CLOSE, P = T.NAVBAR_OPEN, b = T.MOUSE_MOVE, F = T.PAGE_SCROLL_DOWN, x = T.SCROLL_INTO_VIEW, X = T.SCROLL_OUT_OF_VIEW, G = T.PAGE_SCROLL_UP, w = T.SCROLLING_IN_VIEW, U = T.PAGE_FINISH, V = T.ECOMMERCE_CART_CLOSE, j = T.ECOMMERCE_CART_OPEN, H = T.PAGE_START, B = T.PAGE_SCROLL, W = I.IX2EngineConstants.COLON_DELIMITER, Y = (p.IX2VanillaUtils.getNamespacedParameterId,
    function(t) {
        return function(e) {
            return !("object" !== (0,
            u.default)(e) || !t(e)) || e
    ...
    function() {
        ...
        var e, n, o = t.element, r = t.event.config, i = et(), u = i.clientWidth, a = i.clientHeight, c = r.scrollOffsetValue, f = "PX" === r.scrollOffsetUnit ? c : a * (c || 0) / 100;
        return n = {
            left: 0,
            top: f,
            right: u,
        ...
        Object.defineProperties(_miniGl, {
            ...
            Attribute: {
                ...
                value: class {
                    ...
                    update() {
                        void 0 !== this.values && (context.bindBuffer(this.target, this.buffer),
                        context.bufferData(this.target, this.values, context.STATIC_DRAW))
                    }
                    attach(e, t) {
                        const n = context.getAttribLocation(t, e);
                        return this.target === context.ARRAY_BUFFER && (context.enableVertexAttribArray(n),
                        context.vertexAttribPointer(n, this.size, this.type, this.normalized, 0, 0)),
                        n
                    }
                    use(e) {
                        context.bindBuffer(this.target, this.buffer),
                        this.target === context.ARRAY_BUFFER && (context.enableVertexAttribArray(e),
...
paragraphs.forEach(paragraph=>{
    ...
    paragraph.innerHTML = paragraph.textContent.split(' ').filter(text=>text.length > 4).map(text=>`<span class="placeholder__word">${text}</span>`).join(' ')
